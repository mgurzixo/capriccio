                            ...
                            <div class="system-header-row">
                                ...
                                <div class="system-actions">
                                    <q-btn flat round dense class="header-icon-btn" icon="content_paste"
                                        aria-label="Paste EPSG:4326" @click="pasteGroup('wgs84')" />
                                    <q-btn flat round dense class="header-icon-btn" icon="content_copy"
                                        aria-label="Copy EPSG:4326" @click="copyGroup('wgs84')" />
                                </div>
                            </div>
                    ...
                    <q-card-section class="system-header">
                        <div class="system-header-main">
                            <div class="system-header-row">
                                ...
                                <div class="system-actions">
                                    <q-btn flat round dense class="header-icon-btn" icon="content_paste"
                                        aria-label="Paste EPSG:3763" @click="pasteGroup('tm06')" />
                                    <q-btn flat round dense class="header-icon-btn" icon="content_copy"
                                        aria-label="Copy EPSG:3763" @click="copyGroup('tm06')" />
                                </div>
                            </div>
                        ...
                        <div class="system-header-main">
                            <div class="system-header-row">
                                ...
                                <div class="system-actions">
                                    ...
                                    <q-btn flat round dense class="header-icon-btn" icon="content_copy"
                                        aria-label="Copy book coordinates" @click="copyGroup('book')" />
                                </div>
                            </div>
